...
<!--   </div> -->
  ...
  <table id="fresh-table" class="table">
    ...
    <thead>
      <th data-field="id">글번호</th>
      <th data-field="name">분류</th>
      <th data-field="salary">제목</th>
      <th data-field="country">작성자</th>
      <th data-field="city">등록일</th>
      <th data-field="city">조회수</th>
